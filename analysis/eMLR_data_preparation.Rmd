...
if (params_local$cstar_nutrient == "phosphate") {
  ...
  GLODAP <- GLODAP %>%
    mutate(
      cstar = b_cstar_phosphate(tco2, phosphate, talk),
...
if (params_local$cstar_nutrient == "nitrate") {
  ...
  GLODAP <- GLODAP %>%
    mutate(cstar = b_cstar_nitrate(tco2, nitrate, talk),
           rCP_phosphate = -params_local$rCP/params_local$rNP * nitrate,
           talk_05 = -0.5 * talk,
           rNP_phosphate_05 = -0.5 * nitrate)
}
