...
```{r joined_climatology_control_PO4, fig.asp=0.6, eval=FALSE}
p_map_climatology(
  df = predictors, 
  var = "phosphate")
```
...
```{r calculate_phosphate_star_clement, eval=FALSE}
...
```{r PO4_star_climatology_maps, fig.asp=0.6, eval=FALSE}
...
```{r PO4_star_climatology_section, eval=FALSE}
