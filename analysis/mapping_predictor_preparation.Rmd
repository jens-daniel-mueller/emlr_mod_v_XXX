...
predictors_surface <- climatology %>%
  select(lon, lat, depth, basin_AIP, gamma, sal, temp, TCO2, TAlk, 
        # phosphate, 
         silicate)
...
The predictor SiO~3~* was be calculated according to Sarmiento et al. (2004), ie based on silicate and nitrate.

```{r calculate_silicate_star_Sarmiento}
...
```{r SiO3_star_climatology_maps, fig.asp=0.6}
...
```{r SiO3_star_climatology_section}
