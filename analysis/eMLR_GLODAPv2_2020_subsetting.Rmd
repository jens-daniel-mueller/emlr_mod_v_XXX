...
if ("phosphate" %in% params_local$MLR_predictors) {
...
if (!("phosphate" %in% params_local$MLR_predictors) && ("silicate" %in% params_local$MLR_predictors)) {
  GLODAP <- GLODAP %>%
    select(
      year,
      date,
...
} else if (("phosphate" %in% params_local$MLR_predictors) && !("silicate" %in% params_local$MLR_predictors)) {
  GLODAP <- GLODAP %>%
    select(
      year,
      date,
