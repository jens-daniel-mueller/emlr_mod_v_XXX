...
# add estimate label
cant_gamma_maps_long <-
  bind_rows(
    cant_gamma_maps_JDM %>%  mutate(estimate = "JDM"),
...
# i_eras <- unique(cant_gamma_maps_long$eras)[1]
# i_gamma_slab <- unique(cant_gamma_maps_long$gamma_slab)[1]
# i_estimate <- unique(cant_gamma_maps_long$estimate)[1]
