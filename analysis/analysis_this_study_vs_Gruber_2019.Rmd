...
```{r read_modeled_cant_file}

cant_1994 <-
  read_csv(paste(
    path_preprocessing,
    "cant_annual_field_AB/cant_1994.csv",
    sep = ""
  ))
...
cant_2007 <-
  read_csv(paste(
    path_preprocessing,
    "cant_annual_field_AB/cant_2007.csv",
    sep = ""
  ))
...
```{r calculate_modeled_cant_between_tref}

cant_M <- left_join(cant_1994, cant_2007) %>%
...
```{r calculate_zonal_mean_modeled_cant}

cant_zonal_M <- m_zonal_mean_section(cant_gruber)
