...
params_local <-
  lst(
    # the GOBM used for subsetting, currently with options of CESM ("") or NorESM ("NorESM/") or FESOM_REcoM_LR ("FESOM_REcoM_LR/")
    GOBM = "",
    ...
    era_breaks_GLODAP_start = c(1982, 2000, 2008),
    era_breaks_GLODAP_end = c(1999, 2012, 2019),
    era_breaks_random_start = c(1982, 2000, 2008),
    era_breaks_random_end = c(1999, 2012, 2019),
