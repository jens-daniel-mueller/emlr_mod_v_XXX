...
# cant_average_gamma <- cant_average %>%
#   select(lat, lon, depth, eras, basin, basin_AIP, gamma_slab)
# 
# cant_M <- left_join(cant_M, cant_average_gamma)
# 
# cant_M <- cant_M %>%
#   filter(gamma_slab == "(-Inf,26]", depth <= 150)
